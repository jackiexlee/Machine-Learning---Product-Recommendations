...
knitr::opts_knit$set(root.dir ="C:\\Users\\rbapna\\Dropbox\\NYUPredModelingCourse\\____Fal2022\\Labs - in class use-cases\\Lab14- Explaianable NN Based Corporate Bankruptcy Prediction")
...
```
We can infer which has a higher likelihood of bankruptcy out of the 2 observations and which variable(s) appears to influence this high probability. 
